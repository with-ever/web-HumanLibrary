...
INSERT INTO `HUMANBOOK` (`USER_ID`, `TITLE`, `MAIN_CAREER`, `SERVICE_TIME`, `PARENT_CATEGORY`, `SUB_CATEGORY`, `STATE`, `CREATE_TIME`, `UPDATE_TIME`)
VALUES
	('1','hello','WithEver','ALL','20','123','ACCEPT',170324,170324),
	('2','WORLD','NBP','AM','19','120','ACCEPT',170327,170327),
	('3','hi','NAVER','PM','1','1','WAITING',170327,170327),
	('4','Hey there','Gabia','ALL','18','119','CANCEL',170330,170330),
	('5','WORLD','HELLO WORLD','ALL','7','40','ACCEPT',170330,170330),
	('7','what is jQuery','NHN ent.','AM','1','4','ACCEPT',170120,170120),
	('8','what is ajax','Oracle','PM','2','12','WAITING',170121,170120),
	('9','about Spring Framework','Coupang','ALL','3','15','ACCEPT',170122,170122),
	('10','what is Spring','Tmon','PM','4','19','ACCEPT',170123,170123),
	('11','What your hobby','Samsunng','AM','5','25','ACCEPT',170124,170201),
	('12','What is apple','Apple','ALL','6','33','WAITING',170125,170201),
	('13','Bowling','LG','ALL','7','38','ACCEPT',170126,170201),
	('14','When you\'re upset','Hyundai','AM','8','53','ACCEPT',170127,170215),
	('15','when you\'re tired','ebay','PM','9','60','ACCEPT',170128,170215),
	('16','Kakao\'s Future','Kakao','AM','10','66','ACCEPT',170129,170215),
	('17','what is javascript','Daum','AM','11','75','ACCEPT',170130,170215),
	('18','Life Tip','Raon Secure','AM','12','81','CANCEL',170131,170215),
	('19','What is your dream','Kakao Pay','PM','13','86','WAITING',170201,170215),
	('20','How to take pics','Snow','AM','14','91','ACCEPT',170202,170215),
	('21','when you\'re sad','Camp Mobile','AM','15','96','ACCEPT',170203,170215),
	('22','Good Travler','Works Mobile','PM','16','104','WAITING',170204,170220),
	('23','Talk with stranger','Naver Labs','ALL','17','108','ACCEPT',170205,170220),
	('24','how are they work in SDS','Samsung SDS','AM','18','115','ACCEPT',170206,170220),
	('25','How to work in google','Google korea','PM','19','122','ACCEPT',170207,170220),
	('26','About AWS','Amazon','PM','20','129','ACCEPT',170208,170220),
	('27','Game','NC Soft','PM','21','123','ACCEPT',170209,170220),
	('28','Travling to Jungle','Hancom Secure','AM','1','4','ACCEPT',170210,170220),
	('29','what is naver i&s','Naver I&S','AM','2','7','ACCEPT',170211,170301),
	('30','The Future','NHN Technology Service','AM','3','18','ACCEPT',170212,170301),
	('31','Hungry','NIT','PM','5','32','ACCEPT',170213,170301),
	('32','Shopping with wmp','We Make Price','ALL','10','71','ACCEPT',170214,170301),
	('33','Fired Noodle','Auction','AM','13','90','ACCEPT',170215,170301);
